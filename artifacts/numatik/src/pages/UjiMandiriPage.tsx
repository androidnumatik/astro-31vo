      ...
      <main className="relative z-10 mx-auto flex w-full max-w-6xl flex-col gap-6 px-4 py-8 md:px-8">
        <header className="rounded-3xl border p-6 md:p-8" style={{ background: isLight ? "var(--bg-card)" : "rgba(15,23,42,.72)", borderColor: "var(--border)" }}>
          <div className="flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
            <div><div className="mb-3 inline-flex items-center gap-2 rounded-full border px-3 py-1 text-xs font-bold" style={{ color: "#67e8f9", borderColor: "rgba(103,232,249,.3)" }}><ClipboardCheck className="size-4" /> UJI MATEMATIKA DASAR</div><h1 className="font-display text-3xl font-black tracking-tight md:text-5xl" style={{ color: "var(--text-primary)" }}>Cek level matematikamu</h1><p className="mt-2 max-w-2xl font-body text-sm leading-6" style={{ color: "var(--text-secondary)" }}>Pilih paket sesuai tantanganmu. Setiap paket berisi 5 soal pilihan ganda dan hasilnya tercatat di raport sesi ini.</p></div>
