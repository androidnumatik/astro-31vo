...
const VertexFormSVG = () => (
  <svg width="300" height="180" viewBox="0 0 300 180" className="mx-auto">
    <rect x="5" y="5" width="290" height="170" rx="10" fill="var(--card)" stroke="#f59e0b" strokeWidth="1" strokeOpacity="0.4"/>
    <text x="150" y="26" fill="#fcd34d" fontSize="11" fontWeight="bold" textAnchor="middle">Bentuk Vertex: f(x) = a(x−h)² + k</text>
    <line x1="10" y1="32" x2="290" y2="32" stroke="var(--border)" strokeWidth="1"/>
    ...
    <line x1="10" y1="80" x2="290" y2="80" stroke="var(--border)" strokeWidth="1"/>
...
const CompletingSquareSVG = () => (
  <svg width="300" height="190" viewBox="0 0 300 190" className="mx-auto">
    <rect x="5" y="5" width="290" height="180" rx="10" fill="var(--card)" stroke="#a78bfa" strokeWidth="1" strokeOpacity="0.5"/>
    ...
    <line x1="10" y1="93" x2="290" y2="93" stroke="var(--border)" strokeWidth="1"/>
...
const questions: Q[] = [
  ...
  Qn(15,"Rangkuman Titik Puncak – TKA",{type:"mixed",diagram:(
    <svg width="300" height="150" viewBox="0 0 300 150" className="mx-auto">
      <rect x="5" y="5" width="290" height="140" rx="8" fill="var(--card)" stroke="#a78bfa" strokeWidth="1" strokeOpacity="0.4"/>
      ...
      <line x1="7" y1="46" x2="293" y2="46" stroke="var(--border)" strokeWidth="1"/>
  ...
  Qn(25,"Koordinat Puncak dan Jenis Ekstrem – UN",{type:"mixed",diagram:(
    <svg width="300" height="120" viewBox="0 0 300 120" className="mx-auto">
      <rect x="5" y="5" width="290" height="110" rx="8" fill="var(--card)" stroke="#f59e0b" strokeWidth="1" strokeOpacity="0.3"/>
      ...
      <line x1="7" y1="47" x2="293" y2="47" stroke="var(--border)" strokeWidth="1"/>
    ...
    <div className="relative min-h-screen flex flex-col items-center gradient-space overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl w-full px-4 py-10">
        <div className="flex flex-col items-center mb-6">
          ...
          <p className={isDark ? "text-white/50 text-xs text-center font-body" : "text-gray-500 text-xs text-center font-body"}>Kelas 9 · Fungsi Kuadrat · {t('practice.breadcrumb')}</p>
          <div className="mt-3 flex items-center gap-2 bg-violet-500/10 border border-violet-500/30 rounded-lg px-4 py-2">
            <span className="text-violet-400 text-xs font-bold">📋 40 {t('practice.suffixSoal')}</span>
              ...
              <div className="relative px-5 py-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {q.mathContent && <div className={isDark ? "mb-3 bg-violet-900/20 border border-violet-500/20 rounded-lg px-4 py-3 flex justify-center" : "mb-3 bg-violet-50 border border-violet-500/20 rounded-lg px-4 py-3 flex justify-center"}><BlockMath math={q.mathContent}/></div>}
