  ...
  const variants: GameVariant[] = [
    {
      ...
      path: "/math-game-arena/kelas-7/bilangan-bulat/pembagian/pesawat-tembak-meteor",
      from: "#06b6d4",
      to: "#7c3aed",
    ...
    },
    {
      ...
      path: "/math-game-arena/kelas-7/bilangan-bulat/pembagian/galaksi-tempur",
      from: "#7c3aed",
      to: "#ec4899",
    ...
    },
    {
      ...
      path: "/math-game-arena/kelas-7/bilangan-bulat/pembagian/flappy-rocket",
      from: "#f59e0b",
      to: "#ef4444",
    ...
    },
    {
      ...
      path: "/math-game-arena/kelas-7/bilangan-bulat/pembagian/tembak-tank",
      from: "#dc2626",
      to: "#9333ea",
    ...
    },
    {
      ...
      path: "/math-game-arena/kelas-7/bilangan-bulat/pembagian/space-impact",
      from: "#0ea5e9",
      to: "#8b5cf6",
    ...
    },
    {
      ...
      path: "/math-game-arena/kelas-7/bilangan-bulat/pembagian/turtle-run",
      from: "#10b981",
      to: "#06b6d4",
    ...
    },
    {
      ...
      path: "/math-game-arena/kelas-7/bilangan-bulat/pembagian/tetris",
      from: "#06b6d4",
      to: "#a855f7",
    ...
    },
    {
      ...
      path: "/math-game-arena/kelas-7/bilangan-bulat/pembagian/snake-math",
      from: "#22c55e",
      to: "#0ea5e9",
    ...
    },
    {
      ...
      path: "/math-game-arena/kelas-7/bilangan-bulat/pembagian/meteor-pantul",
      from: "#f97316",
      to: "#a855f7",
        ...
        <div className="relative z-10 max-w-3xl w-full px-4 py-10">
          <div className="text-center mb-8">
            ...
            <div className="mt-3 flex items-center justify-center gap-2 text-white/40 text-[11px] font-body">
              <span>🎮</span>
              <span>{t('gameArena.chooserTagline', { topic: 'pembagian bilangan bulat' })}</span>
            </div>
          </div>
