...
const variants: GameVariant[] = [
  ...
  },
  {
    ...
    path: "/math-game-arena/kelas-7/bilangan-bulat/penjumlahan/galaksi-tempur",
    from: "#7c3aed",
    to: "#ec4899",
  ...
  },
  {
    ...
    path: "/math-game-arena/kelas-7/bilangan-bulat/penjumlahan/meteor-pantul",
    from: "#f97316",
    to: "#a855f7",
  ...
  },
  {
    ...
    path: "/math-game-arena/kelas-7/bilangan-bulat/penjumlahan/zum-math",
    from: "#a855f7",
    to: "#6366f1",
    glow: "rgba(168,85,247,0.4)",
    variantKey: "zum",
      ...
      <div className="relative z-10 max-w-3xl w-full px-4 py-10">
        <div className="text-center mb-8">
          ...
          <div className="mt-3 flex items-center justify-center gap-2 text-white/40 text-[11px] font-body">
            <span>🎮</span>
            <span>{t('gameArena.chooserTagline', { topic: 'penjumlahan bilangan bulat' })}</span>
          </div>
        </div>
              ...
              >
                {v.path.endsWith("/pesawat-tembak-meteor") ? (
                  ...
                  <svg viewBox="0 0 52 52" style={{ width: 46, height: 46, filter: "drop-shadow(0 0 10px #facc15) drop-shadow(0 0 22px #f59e0b)" }}>
                    <defs>
                      <radialGradient id="bb-pjm-pac" cx="35%" cy="28%" r="65%">
                    ...
                    <path d="M26,26 L48,14 A22,22 0 1,0 48,38 Z" fill="url(#bb-pjm-pac)"/>
