  ...
  const variants: GameVariant[] = [
    {
      ...
      path: "/math-game-arena/kelas-7/bilangan-bulat/kpk-fpb/pesawat-tembak-meteor",
      from: "#06b6d4",
      to: "#7c3aed",
    ...
    },
    {
      ...
      path: "/math-game-arena/kelas-7/bilangan-bulat/kpk-fpb/flappy-rocket",
      from: "#f59e0b",
      to: "#ef4444",
    ...
    },
    {
      ...
      path: "/math-game-arena/kelas-7/bilangan-bulat/kpk-fpb/tembak-tank",
      from: "#dc2626",
      to: "#9333ea",
    ...
    },
    {
      ...
      path: "/math-game-arena/kelas-7/bilangan-bulat/kpk-fpb/space-impact",
      from: "#0ea5e9",
      to: "#8b5cf6",
    ...
    },
    {
      ...
      path: "/math-game-arena/kelas-7/bilangan-bulat/kpk-fpb/turtle-run",
      from: "#10b981",
      to: "#06b6d4",
    ...
    },
    {
      ...
      path: "/math-game-arena/kelas-7/bilangan-bulat/kpk-fpb/tetris",
      from: "#06b6d4",
      to: "#a855f7",
    ...
    },
    {
      ...
      path: "/math-game-arena/kelas-7/bilangan-bulat/kpk-fpb/snake-math",
      from: "#22c55e",
      to: "#0ea5e9",
    ...
    },
    {
      ...
      path: "/math-game-arena/kelas-7/bilangan-bulat/kpk-fpb/meteor-pantul",
      from: "#f97316",
      to: "#a855f7",
    ...
    },
    {
      ...
      path: "/math-game-arena/kelas-7/bilangan-bulat/kpk-fpb/zum-math",
      from: "#a855f7",
      to: "#6366f1",
      glow: "rgba(168,85,247,0.4)",
    variantKey: "zum",
    },
    {
      ...
      path: "/math-game-arena/kelas-7/bilangan-bulat/kpk-fpb/pac-math",
      from: "#eab308",
      to: "#f97316",
        ...
        <div className="relative z-10 max-w-3xl w-full px-4 py-10">
          <div className="text-center mb-8">
            ...
            <div className="mt-3 flex items-center justify-center gap-2 text-white/40 text-[11px] font-body">
              <span>🎮</span>
              <span>{t('gameArena.chooserTagline', { topic: 'kpk dan fpb' })}</span>
            </div>
          </div>
                ...
                >
                  {v.path.endsWith("/pesawat-tembak-meteor") ? (
                    ...
                    <svg viewBox="0 0 52 52" style={{ width: 46, height: 46, filter: "drop-shadow(0 0 10px #facc15) drop-shadow(0 0 22px #f59e0b)" }}>
                      <defs>
                        <radialGradient id="bb-kpk-pac" cx="35%" cy="28%" r="65%">
                      ...
                      <path d="M26,26 L48,14 A22,22 0 1,0 48,38 Z" fill="url(#bb-kpk-pac)"/>
